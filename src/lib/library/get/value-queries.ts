...
const defineQuery =
	<Store extends LibraryValueStoreName>(storeName: Store) =>
...
type LibraryItemQuery<Store extends LibraryValueStoreName> = ReturnType<typeof defineQuery<Store>>
